    ...
    const moreMenu = [
      ...
      },
      {
        ...
        items: [
          ...
          //     id: "streamer-mode",
          //     label: streaming ? (
          //       <FormattedMessage id="more-menu.exit-streamer-mode" defaultMessage="退出 Streamer 模式" />
          //     ) : (
          //       <FormattedMessage id="more-menu.enter-streamer-mode" defaultMessage="进入 Streamer 模式" />
          //     ),
          //     icon: CameraIcon,
